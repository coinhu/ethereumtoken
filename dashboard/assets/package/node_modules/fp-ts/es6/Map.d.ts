...
declare const filter: {
    ...
    <A_1>(predicate: Predicate<A_1>): <E_1>(fa: Map<E_1, A_1>) => Map<E_1, A_1>
  },
  ...
  partition: {
    ...
    <A_1>(predicate: Predicate<A_1>): <E_1>(fa: Map<E_1, A_1>) => Separated<Map<E_1, A_1>, Map<E_1, A_1>>
  },
  partitionMap: <A, B, C>(f: (a: A) => Either<B, C>) => <E>(fa: Map<E, A>) => Separated<Map<E, B>, Map<E, C>>,
  compact: <E, A>(fa: Map<E, Option<A>>) => Map<E, A>,
  separate: <E, A, B>(fa: Map<E, Either<A, B>>) => Separated<Map<E, A>, Map<E, B>>
export {
  /**
   * @since 2.0.0
   */
