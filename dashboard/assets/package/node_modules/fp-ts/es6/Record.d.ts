 ...
 * @since 2.0.0
 */
export declare function hasOwnProperty<K extends string>(k: string, r: Record<K, unknown>): k is K
/**
 ...
 * @since 2.0.0
 */
export declare function updateAt<A>(k: string, a: A): <K extends string>(r: Record<K, A>) => Option<Record<K, A>>
/**
 * @since 2.0.0
 */
