...
function comprehension(input, f, g) {
    ...
    var go = function (scope, input) {
        if (input.length === 0) {
            ...
            return exports.array.chain(input[0], function (x) { return go(snoc(scope, x), input.slice(1)); });
        }
    };
...
exports.array = {
    ...
    partitionMap: function (fa, f) { return exports.array.partitionMapWithIndex(fa, function (_, a) { return f(a); }); },
    of: exports.of,
    ap: function (fab, fa) { return flatten(exports.array.map(fab, function (f) { return exports.array.map(fa, f); })); },
    chain: function (fa, f) {
        var resLen = 0;
        var l = fa.length;
    ...
    reduceRight: function (fa, b, f) { return exports.array.reduceRightWithIndex(fa, b, function (_, a, b) { return f(a, b); }); },
    unfold: function (b, f) {
        var ret = [];
        var bb = b;
        while (true) {
    ...
    sequence: function (F) { return function (ta) {
        return exports.array.reduce(ta, F.of(exports.array.zero()), function (fas, fa) {
