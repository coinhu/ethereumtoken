 ...
 * @since 2.2.0
 */
export declare function init<A>(nea: NonEmptyArray<A>): Array<A>
/**
 * @since 2.0.0
 */
...
declare const fold: <A>(S: Semigroup<A>) => (fa: NonEmptyArray<A>) => A
declare const foldMapWithIndex: <S>(S: Semigroup<S>) => <A>(f: (i: number, a: A) => S) => (fa: NonEmptyArray<A>) => S
declare const foldMap: <S>(S: Semigroup<S>) => <A>(f: (a: A) => S) => (fa: NonEmptyArray<A>) => S
export {
  /**
   * @since 2.0.0
   */
